...
describe "lecture 7" do
  ...
  describe "user feed" do
    ...
    describe "authenticated" do
      ...
      before do
        50.times { |i| @user.microposts.create! content: "hello, world #{i}!" }
        user_login @user
      end
  ...
  describe "posting from the home page" do
    ...
    describe "anonymous" do
      it "should not display the MicroPost form to anonymous users" do
        visit root_path
        page.should_not have_css "[name='micropost[content]']"
      end
    end
    ...
    describe "authenticated" do
      ...
      it "should show the MicroPost form" do
        ...
        page.should have_css "[name='micropost[content]']"
      end
  ...
  describe "deleting microposts" do
    ...
    describe "authenticated" do
      ...
      it "should display the destroy link for only your microposts" do
        visit root_path
        page.should have_css "a[data-remote='true'][data-method='delete']"
      end

      it "should not display destroy links for other users microposts" do
